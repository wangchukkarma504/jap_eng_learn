...
const App: React.FC = () => {
    ...
    return (
      <div className="min-h-screen bg-[#FDFDFE] flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-3xl flex items-center justify-center text-white shadow-xl shadow-indigo-100/50 mx-auto mb-4">
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-[#FDFDFE] flex items-center justify-center px-4">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            <div className="w-20 h-20 bg-gradient-to-br from-indigo-600 to-violet-600 rounded-3xl flex items-center justify-center text-white shadow-xl shadow-indigo-100/50 mx-auto mb-6">
              <i className="fas fa-language text-4xl"></i>
            </div>
            <h1 className="text-3xl font-black text-slate-900 mb-2">{t.appTitle}</h1>
            <p className="text-slate-500 text-sm">{t.appSubtitle}</p>
          </div>
          
          <button
            onClick={handleSignIn}
            className="w-full bg-white border-2 border-slate-200 rounded-2xl px-6 py-4 flex items-center justify-center gap-3 hover:border-indigo-300 hover:shadow-lg transition-all active:scale-95"
          >
    ...
    <div className="min-h-screen bg-[#FDFDFE] flex flex-col items-center py-6 sm:py-12 px-4 text-slate-900 font-jp overflow-x-hidden select-none">
      ...
      <header className="max-w-2xl w-full mb-8 flex flex-col sm:flex-row justify-between items-center gap-6">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          {/* User Profile */}
          {user && (
            <div className="flex items-center gap-3 bg-white rounded-2xl px-4 py-2 shadow-sm border border-slate-100">
              {user.photoURL && (
                <img 
                  src={user.photoURL} 
              ...
              <button
                ...
                className="w-8 h-8 rounded-lg bg-slate-50 hover:bg-slate-100 flex items-center justify-center text-slate-500 hover:text-slate-700 transition-all active:scale-95"
                title="Sign out"
              >
